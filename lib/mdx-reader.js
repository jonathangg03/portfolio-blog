...
const getAllFilesMetadata = () => {
  ...
  return files.reduce((allPosts, postSlug) => {
    ...
    // console.log('as', allPosts.entries)
    return {
      categories: [...allPosts.categories, !allPosts.categories.includes(data.category) && data.category],
      entries: [
        ...allPosts.entries,
        {
          ...data,
          slug: postSlug.replace('.mdx', '')
        }, //allPost is the accumulator, so, it needs to be returned
        // ...allPosts.entries
      ],
    }
  }, {
